---
title: "【感動】 \"まじん式\" HTMLスライド生成プロンプトを試してほしい！｜まじん"
source: "https://note.com/majin_108/n/nee9969b116ac"
author:
  - "[[まじん]]"
published: 2025-08-22
created: 2025-08-23
description: "こんにちは､まじんです｡  「【神回】Googleスライドが一瞬で完成する\"奇跡\"のプロンプト教えます」のアプローチにたどり着く前に、HTML形式のスライド作成を研究していた時期がありました｡今回はその内容をご紹介します。                             Canvasで何やってんの？ https://t.co/Uk8xmnfcdQ pic.twitter.com/xe8oXFfQc5 — まじん｜AI × Google (@Majin_AppSheet) August 22, 2025                実務で活躍するのはやっぱりG"
tags:
  - "clippings"
  - "プロンプト"
  - "ai"
  - "プロダクト"
  - "コード"
image: "https://assets.st-note.com/production/uploads/images/210233946/rectangle_large_type_2_88936154321273726a8ce467d7bf9511.png?fit=bounds&quality=85&width=1280"
---
![見出し画像](https://assets.st-note.com/production/uploads/images/210233946/rectangle_large_type_2_88936154321273726a8ce467d7bf9511.png?width=1200)

## 【感動】 "まじん式" HTMLスライド生成プロンプトを試してほしい！

[まじん](https://note.com/majin_108)

こんにちは､まじんです｡

「 [**【神回】**](https://note.com/majin_108/n/n39235bcacbfc) [**Google**](https://note.com/majin_108/n/n39235bcacbfc) [**スライドが一瞬で完成する**](https://note.com/majin_108/n/n39235bcacbfc) [**"**](https://note.com/majin_108/n/n39235bcacbfc) [**奇跡**](https://note.com/majin_108/n/n39235bcacbfc) [**"**](https://note.com/majin_108/n/n39235bcacbfc) [**のプロンプト教えます**](https://note.com/majin_108/n/n39235bcacbfc) 」のアプローチにたどり着く前に、 **HTML形式のスライド作成** を研究していた時期がありました｡今回はその内容をご紹介します。

実務で活躍するのはやっぱりGoogleスライド｡  
HTML版は使いどころを選ぶものの､かなり **ユニーク** でお気に入りです(笑)
...
**すでにプロンプトがセットされたGemを使うこと** を前提に解説します。  
まじん式は文字数が多めで、今回も4～5万字ありますが、 **無料版のGeminiでも、プロンプトをMDファイルにして「知識」として添付すれば使えます！**

![画像](https://assets.st-note.com/img/1755858277-dKTyza9hC4l0p1EADZnL357e.png?width=1200)

「MDファイルってなに？」という方はGeminiに聞いてみて｡

### ① スライドの元ネタを用意する

Googleスライド同様､素材はなんでも構いません｡  
この解説では､安野たかひろさん（#チームみらい）のnoteを使用させていただいております｡

まずは私の愛用ツール「 [**Obsidian Web Clipper**](https://chromewebstore.google.com/detail/obsidian-web-clipper/cnjifjpddelmedmihgijeibhnjfabmlf) 」で全文コピー｡

![画像](https://assets.st-note.com/img/1755836424-fkDzRuSGnaljbUw4Qq30oWBP.png?width=1200)

### ②Gemにテキストを貼り付けて"Canvas"オンで送信

![画像](https://assets.st-note.com/img/1755836545-CAQP2rEVlOXDKFBIkTJo98yz.png?width=1200)

### ③ 完成スライドがCanvasにプレビューされる

まぁ､ **普通のスライド** って感じ｡  
これならシンプルな指示でも作れるのでは…？  
ん…？

![画像](https://assets.st-note.com/img/1755864227-tQobIuqOgkXn9BWlChPYcx0S.png?width=1200)

このボタンなに…？

![画像](https://assets.st-note.com/img/1755864338-PdQ5K2w1r0iDtA7SjWIVhEqc.png?width=1200)

そう｡  
このプロンプト､ **Canvas上でスライドを編集** できちゃうんです…！

![画像](https://assets.st-note.com/img/1755864384-6CAXe3OPy8vEziuJGSl7nk2d.png?width=1200)

テキスト編集

![画像](https://assets.st-note.com/production/uploads/images/210192268/picture_pc_6cfe572a2e3e2924d4af9b0bb18a6faa.gif?width=1200)

画像のリサイズ・削除

![画像](https://assets.st-note.com/production/uploads/images/210196604/picture_pc_37cd8eeffb996fed6b90f3f2b9651856.gif?width=1200)

スライドごと削除

![画像](https://assets.st-note.com/production/uploads/images/210195587/picture_pc_952566392645dc78a8e78b00b1774c26.gif?width=1200)

グリッド表示

![画像](https://assets.st-note.com/production/uploads/images/210196056/picture_pc_a81ea07ca20a633b0e9c8e05997e291f.gif?width=1200)

スライドの並び替え

![画像](https://assets.st-note.com/production/uploads/images/210196283/picture_pc_3acd9f97601d67dfb7516bbc2bfd72dc.gif?width=1200)

選択したスライドにジャンプ

間違って削除しても大丈夫｡  
**ブラウザをリロードすれば初期状態に戻ります｡**

ただし、上記以外の細かな編集機能は用意していません。  
なぜなら､ **Geminiに頼めばいいから｡**

試しに､修正したい箇所のスクショを貼ってお願いしてみます｡

![画像](https://assets.st-note.com/img/1755834594-nzYvEtfX2QWohAleUswGg0BH.png)

ちゃんとリクエストどおりに修正してくれました！  
スライドも **バイブコーディング** する時代ですね✨

![画像](https://assets.st-note.com/img/1755834765-7nawZYU3mheTgf1rdORS29HL.png?width=1200)

さて､編集が完了したらこの **青いボタン** をクリックしましょう｡  
**プレビュー画面からHTMLファイルをダウンロード** できます。

![画像](https://assets.st-note.com/img/1755864852-sWObaJV7kP2iLr56H4xCKA8m.png?width=1200)

ダウンロードしたファイルを開くと、ブラウザ上で **全画面表示** されます。  
そして……見てください、このボタン。

![画像](https://assets.st-note.com/img/1755865907-Pyq8Km9OFfjXxRShr1s7niEv.png?width=1200)

なんと…… **スライドショー機能** も搭載｡

![画像](https://assets.st-note.com/production/uploads/images/210197973/picture_pc_e360b3172758391cfa5d7535d3a362f7.gif?width=1200)

スライドショーでもグリッド表示/ページジャンプ対応｡

![画像](https://assets.st-note.com/img/1755866156-PC3BnFRdOpJh0yYfI9GLTx72.png?width=1200)

おまけ程度の **スピーカーノート** （相手にも見えちゃいますが…）

![画像](https://assets.st-note.com/img/1755866306-e2PdajZEwRinFQgtM8cOHzyo.png?width=1200)

さらに､ **レーザーポインター機能** までついてる…！

![画像](https://assets.st-note.com/production/uploads/images/210198818/picture_pc_555445a8af81a03bfe2f0e4a8e711546.gif?width=1200)

**社内向けの資料** なら、この形で十分な場合もありそうですね！  
もちろんブラウザの標準機能で **印刷やPDF保存** ができます✨  
（A4サイズに合わせて少し縮小されます💦）

![画像](https://assets.st-note.com/img/1755835873-DPmAikJ20nVgyEldTMp93GcZ.png?width=1200)

オフラインイベントでは印刷もあり！

いかがでしたか？  
正直、 **Gemini単体** でここまでできたのは、私もびっくりでした。

しかも、このプロンプト―― **まだまだ遊べます** ！  
次は、 **応用テクニック** をご紹介します。

## 【応用編】

Googleスライド版では、あらかじめ **スライドの型を定義し、その枠組みにデータを流し込む設計** を採用していました。これは構文エラーを防ぐための工夫です。  
一方、HTML形式であれば厳密な型定義がなくてもエラーにはなりにくいため、スライドのデザインはある程度AIに委ねつつ、 **編集機能などのオプション部分に「コード固定」の設計思想を取り入れています。**

つまり――スライドのデザインはAI次第。  
ということは **「プロンプト次第」で自由自在に変化するのです！**

では、さっそく実験してみましょう。

## プロンプトの冒頭でリクエストするだけ

このように元ネタの前に要望を書けばデザインが変わります｡
...
![画像](https://assets.st-note.com/img/1755862824-XvhfMZdLirOTKuRDV3eYpPs9.png?width=1200)

### ②「画像を取り入れて｡」

このように指示すると挿入する画像が増えるようです｡

![画像](https://assets.st-note.com/img/1755863169-AvGM4wkB3apYHVQ2dFZ7Whsu.png?width=1200)

### ③「黄金郷のような豪華絢爛なデザインにして｡」

ギラギラだ…！

![画像](https://assets.st-note.com/img/1755863253-04NMalf2H3x5LicUAtDhjpsQ.png?width=1200)

### ④「 この画像からインスピレーションを受けてデザインを考えて｡」

全然 受けてないじゃん…笑

![画像](https://assets.st-note.com/img/1755862960-kifdz9v8VGgm6KecqACa0YnL.png?width=1200)

こんな感じで、 **かなり“遊び甲斐”のあるプロンプト** に仕上がったと思います✨  
ぜひ皆さんの「 **やってみた！** 」を教えてください！

ちなみに、HTML版プロンプトとの格闘ストーリーは以前こちらのnoteにまとめていますが……今回このnoteを書くにあたり、 **さらに機能をアップグレード** しました！

## 【全文公開】HTMLスライドジェネレーターマスタープロンプト
...
> **【ご利用上の注意】**  
> ✅ **1\. 使用するAIモデルは「Gemini 2.5 Pro」に限定**  
> ChatGPTやClaudeでも動作はしますが、デザイン性が低く、おすすめできません。これは、今回Geminiで出力を検証・チューニングした影響かもしれません。  
>   
> ✅ **2\. 各機能が正常に動作しない場合があります**  
> グリッド表示やダウンロード時に背景が消えるなど、バグが発生することがあります。その際は、 **不具合をGeminiに伝える** か、 **新しいチャットでやり直す** のがスムーズです。  
>   
> ✅ **3\. HTMLデザインにはランダム性があります**  
> Googleスライド版のようにスライド構成を固定するプロンプトではないため、 **出力結果にばらつきがあります** 。  
> 微妙なアイコンが生成されたり、デザインに違和感が出る場合は、 **編集機能で削除する** か、 **Geminiに修正依頼を出して整える** のが効果的です。
...
Xでの感想シェア** もいただければ､次の開発のエネルギーになります🔥
...
[前多昌顕](https://note.com/kumaya77)

天才

[療育と運動遊びを生業とする理学療法士](https://note.com/kouki_teramoto)
